...
#pragma endregion 복습 2
	...
	m_SecondSplitter.CreateView(0, 0, RUNTIME_CLASS(CMiniView), CSize(400, 300), pContext);
	m_SecondSplitter.CreateView(1, 0, RUNTIME_CLASS(CMyForm), CSize(400, 200), pContext);
	m_SecondSplitter.CreateView(2, 0, RUNTIME_CLASS(CMapToolGround), CSize(400, 300), pContext);
